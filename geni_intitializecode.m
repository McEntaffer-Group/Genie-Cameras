function out = geni_intitializecode
%GENI_INTITIALIZECODE Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, GENI_INTITIALIZECODE.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, geni_intitializecode, at the MATLAB command prompt.
%   
%   The code file, GENI_INTITIALIZECODE.M and its associated MAT-file, GENI_INTITIALIZECODE.MAT (if
%   it exists) must be on your MATLAB path.
%   
%   Example: 
%       vidobj = geni_intitializecode;
%   
...
try
    MATvar = load('C:\Users\PSU_Staging\Documents\MATLAB\geni_intitializecode');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\PSU_Staging\Documents\MATLAB\geni_intitializecode.mat.
if (MATLoaded)
...
set(srcObj1(1), 'counterIncrementalLineActivation', '(Currently not accessible)');
set(srcObj1(1), 'counterResetLineActivation', '(Currently not accessible)');
set(srcObj1(1), 'DeviceTemperature', 45.8297);
set(srcObj1(1), 'exposureDelay', '(Currently not accessible)');
set(srcObj1(1), 'multipleROICount', '(Currently not accessible)');
set(srcObj1(1), 'multipleROICountHorizontal', '(Currently not accessible)');
set(srcObj1(1), 'multipleROICountVertical', '(Currently not accessible)');
set(srcObj1(1), 'multipleROIHeight', '(Currently not accessible)');
set(srcObj1(1), 'multipleROIMode', '(Currently not accessible)');
set(srcObj1(1), 'multipleROIOffsetX', '(Currently not accessible)');
set(srcObj1(1), 'multipleROIOffsetY', '(Currently not accessible)');
set(srcObj1(1), 'multipleROISelector', '(Currently not accessible)');
set(srcObj1(1), 'multipleROIWidth', '(Currently not accessible)');
set(srcObj1(1), 'outputLinePulseActivation', '(Currently not accessible)');
set(srcObj1(1), 'outputLinePulseDelay', '(Currently not accessible)');
set(srcObj1(1), 'outputLinePulseDuration', '(Currently not accessible)');
set(srcObj1(1), 'outputLineSource', '(Currently not accessible)');
set(srcObj1(1), 'outputLineValue', '(Currently not accessible)');
set(srcObj1(1), 'PacketSize', 1452);
set(srcObj1(1), 'TriggerActivation', '(Currently not accessible)');
set(srcObj1(1), 'TriggerDelay', '(Currently not accessible)');
set(srcObj1(1), 'triggerFrameCount', '(Currently not accessible)');
set(srcObj1(1), 'TriggerOverlap', '(Currently not accessible)');
set(srcObj1(1), 'TriggerSource', '(Currently not accessible)');
